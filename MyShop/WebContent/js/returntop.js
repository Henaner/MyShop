document.write('<div id="k_icopos" class="k_spico"><a href="javascript:void(0)" hidefocus="true" class="k_returntop bb" id="k_returntop" title="返回顶部">&nbsp;</a></div><style>.k_spico {width:50px;height:50px;position:fixed;_position:absolute;display:none;cursor:pointer;}.k_returntop {display:block;width:50px;height:50px;background:url(./images/top_arrow.png) no-repeat 0 0;}.k_returntop:hover {filter:alpha(opacity=50);opacity:0.5;text-decoration:none;}</style>');
...
var toTop = new ReturnTop('k_icopos','k_returntop',350,1230);//这里可以控制返回顶部控件的距右侧的距离