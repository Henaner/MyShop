...
<body>
	...
	<div  style="position: absolute;margin-top:210px;width:99%;margin-left:3px;">
		...
		<div style="position:absolute;margin-top:-8px;margin-left:62px;border:solid 1px #9D2A29;width:90%;height:500px;">
			<div style="margin-top:100px;" align="center"><img src="<%=request.getContextPath()%>/images/icon/ord_success.png" style="width:80px;height:80px;"><p style="margin-top:0px;"><font color="#9D2A29" size="+3">恭喜您，支付成功！</font></p></div>
